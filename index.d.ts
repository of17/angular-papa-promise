declare namespace PapaPromise {
    interface Static {
        /**
         * Parse a csv string or a csv file
         */
        parse(csvString: string, config?: ParseConfig): ng.IPromise<ParseResult>;

        parse(file: File, config?: ParseConfig): ng.IPromise<ParseResult>;

        /**
         * Unparses javascript data objects and returns a csv string
         */
        unparse(data: Array<Object>, config?: UnparseConfig): ng.IPromise<ParseResult>;

        unparse(data: Array<Array<any>>, config?: UnparseConfig): ng.IPromise<ParseResult>;

        unparse(data: UnparseObject, config?: UnparseConfig): ng.IPromise<ParseResult>;
...
declare var Papa: PapaPromise.Static;

declare module 'papapromise' {
    var Papa: PapaPromise.Static;
    export = Papa;
}
